...
soqlCommonLiterals
      ...
      | {this.helper.isDateFormula(this._input.LT(1).getText())}? IDENTIFIER (COLON INTEGER_LITERAL)?       #soqlDateFormulaLiteral
      | {this.helper.isMultiCurrencyEnabled() && this.helper.isCurrency(this._input.LT(1).getText())}? IDENTIFIER    #soqlMultiCurrency
      ;
...
validatedEscapeStringLiteralElement
    : ESCAPE_CHAR VALID_ESCAPE_LIKE_CHAR {notifyErrorListeners("Invalid Escape Character");}
